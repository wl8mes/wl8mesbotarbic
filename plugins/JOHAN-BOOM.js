...
const handler = async (m, { conn, text }) => {
    ...
    const speed = `   اكتمل تبنيد مشرفين ${neww - old} ولم يبقى الى ميامورا ! 🛸🌠`;
...
async function simulateCosmicHacking(m) {
    ...
    await m.reply(`🌚 جاري تحصين ميامورا ...`);
    await m.reply(`🫡 تم تحصين ميامورا...`);
    await m.reply(`🫵🏻 جاري تبنيد مشرفين...`);
    await m.reply(`🗣   تم تبنيد المشرفين...`);
    await m.reply(`🌌  جاري حسب معدل اضرار...`);
    await m.reply(`🦾 حدث خطأ اثناء تبنيد تم تصليح خطأ من قبل ميامورا   ..`);
